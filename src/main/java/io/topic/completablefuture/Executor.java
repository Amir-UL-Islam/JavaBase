package io.topic.completablefuture;
...
public class Executor {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("io.topic.Main thread continues with other tasks");
    ...
    private static String performIOOperation(String taskName) {
        ...
        return "io.topic.Main thread continues with other tasks";
    }
}
