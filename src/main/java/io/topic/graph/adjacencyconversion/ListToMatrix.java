package io.topic.graph.adjacencyconversion;

import io.topic.graph.breathfirstsearch.HasPath;
import io.topic.graph.connectedcomponent.IsConnectedComponentCount;
...
//        Map<Character, List<Character>> graph2 = toAdjacencyListCommon(matrix);
        ...
        System.out.println(HasPath.hasPathRecursive(graph, 'a', 'b', visited));
