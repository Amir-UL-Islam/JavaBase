package io.topic;//JDK is for development purpose whereas JRE is for running the java programs.
//JDK and JRE both contains JVM so that we can run our java program.
//JVM is the heart of java programming language and provides platform independence.


// The io.topic.Main Class
// with public access modifier
public class Main {
//     main is a Method
    public static void main(String[] args) {  // void is for not returning anything.
        byte age = 22; // byte data type takes -128 to 128, which is enough for age Variable
